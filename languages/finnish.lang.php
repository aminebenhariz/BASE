...
DEFINE('_LOGINERROR','Käyttäjää ei ole tai antamasi salasana on väärä!<br>Yritä uudelleen');
...
DEFINE('_ADDAGID','Lisää AG:iin ( ID:llä');//#
...
DEFINE('_ARCHIVEALERTSMOVE','Arkistoi hälytykset (siirrï¿½');
...
DEFINE('_ERRSQLCONNECTINFO','<P>Tarkista DB connection variables(tietokantayhteyden muuttujat) tiedostosta <I>base_conf.php</I> 
              <PRE>
               ...
               = $alert_password : salasana käyttäjänimelle
              </PRE>
              <P>');
...
DEFINE('_ERRAGIDSEARCH','Annettu AG ID etsintä on laiton(invalid).  Yritä uudelleen!');
...
DEFINE('_CHRTSIGNUMBER','Signature Classification vs. Hälytysten Määrä');//#
...
DEFINE('_SCSENSORTOTAL','Sensorit/Yhteensï¿½');
...
DEFINE('_BASEUSERERRPWD','Salasana ei voi olla tyhjä tai salasanat eivät täsmää!');
